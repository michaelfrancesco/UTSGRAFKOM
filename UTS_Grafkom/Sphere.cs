...
namespace Tugas_Individu
{
    class Sphere : Mesh
    {
        ...
        public Sphere(List<Vector3> vertices, List<Vector3> textureVertices, List<Vector3> normals, List<uint> vertexIndices, int vertexBufferObject, int vertexArrayObject, Shader shader, int elementBufferObject, Matrix4 transform)
        {
        ...
        public Sphere(string color = "red", string name = "allen")
        {
            this.color = color;
            this.name = name;
        }
